...
@ejecucion_consultas_router.get("/ejecutar_consulta", tags=['Caso_uso_reportes'], status_code=200, dependencies=[Depends(JWTBearer())])
def ejecutar_consulta(consulta: str = Query(...)):
    """
    ## **Descripción:**
